...
//               {adminOpen && (
//                 <ul className={`mt-1 space-y-1 ${isSidebarOpen ? 'ml-3' : 'flex flex-col items-center'}`}>
//                   {adminSubmenu.map((s) => {
...
//                           className={`flex items-center rounded-md py-2 text-left transition-colors w-full ${
//                             isActive
//                               ? 'bg-primary text-primary-foreground'
//                               : 'text-muted-foreground hover:bg-accent hover:text-accent-foreground'
//                           } ${isSidebarOpen ? 'px-3' : 'justify-center px-0 w-10 h-10'}`}
//                           title={s.label}
//                         >
